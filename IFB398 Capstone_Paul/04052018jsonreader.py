...
for x in range(10):
    ...
    #for i in title:
    resultGUI.insert(INSERT,title)
        
    resultGUI.insert(END,"\n")
    
    #for j in isbn_type:
    resultGUI.insert(INSERT,isbn_type)

    resultGUI.insert(END,"\n")
    
    #for k in isbn_num:
    resultGUI.insert(INSERT,isbn_num)

    resultGUI.insert(END,"\n")
    
    #for l in author:
    resultGUI.insert(INSERT,author)

    resultGUI.insert(END,"\n")
    
    #for m in date_flipped:
    resultGUI.insert(INSERT,date_flipped)

    resultGUI.insert(END,"\n")
    
    #for n in price:
    resultGUI.insert(INSERT,price)
